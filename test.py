...
for i in range(len(game.board.get_provinces())):
    print(game.board.get_provinces()[i].get_pillage_reward()) """

game = BloodRage()
print(game.board.provinces[11].get_sub())
print(game.board.provinces[12].get_sub())